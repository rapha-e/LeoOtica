...
class BlockModel(Base):
    ...
    average_cost_price: Mapped[Decimal] = mapped_column(Numeric(10, 2), default=Decimal("35.00"), nullable=False)
    last_purchase_price: Mapped[Decimal] = mapped_column(Numeric(10, 2), default=Decimal("35.00"), nullable=False)
